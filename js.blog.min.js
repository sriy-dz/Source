...
// Ctrl u
var _0x4300=["onkeydown","ctrlKey","keyCode","Tempalte by Quang Sáng?","OK, Người ta cho đằng ấy copy đấy nha. Ahihi!!!","Địt mẹ mày =)) Cố chấp vl"];document[_0x4300[0]]=function(n){if(n[_0x4300[1]]&&85===n[_0x4300[2]]){if(1!=confirm(_0x4300[3]))return alert(_0x4300[5]),!1;alert(_0x4300[4])}};
// console
console.log('%cDeveloped by Quang Sáng 😎\n=> https://fb.com/JobyS.Official\nMua template liên hệ mình nhé!', 'font:2.5em Roboto;color:#ff0000')
/* Js áp dụng cho cả blog - www.quangsang.tk */
